...
export default function Testing(){
  ...
  return (
    <section className="flex flex-col items-center justify-center flex-grow text-center px-4 gap-8 min-h-screen">
      <h2 className="text-2xl font-bold">Testing — SAT & ACT</h2>
      <p className="text-slate-700">Links to Khan Academy and ACT official resources. Provide strategies PDFs in /public and link them here.</p>
    </section>
  )
}
